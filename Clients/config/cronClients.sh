...
do
	...
	curl -L -s "$URL" --interface $WLAN_TLS_PHISHING -H 'Content-Type: application/x-www-form-urlencoded' --data-raw 'username=CORPO\god&password=123456789' -c /tmp/userTLSPhishing -b /tmp/userTLSPhishing > /dev/null &
	# Responder ""vuln""
