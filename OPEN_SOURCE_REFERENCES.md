...
| mac80211_hwsim (patched)           | Virtual Wi-Fi radios; patched and rebuilt into the AP image    | https://git.kernel.org/pub/scm/linux/kernel/git/stable/linux.git/tree/drivers/net/wireless/virtual/mac80211_hwsim.c | GPL-2.0                          |
...
| OpenSSL                            | TLS library / CLI (built from source, openssl-3.2.1)           | https://github.com/openssl/openssl                                    | Apache-2.0                       |
| macchanger                         | MAC address changer used across images                         | https://github.com/alobbs/macchanger                                  | GPL-3.0                          |
...
| eapeak                             | EAP handshake analysis tool (attacker image)                   | https://github.com/securestate/eapeak                                 | BSD-3-Clause                     |
| Responder                          | Responder.conf pulled for eaphammer configuration              | https://github.com/lgandx/Responder                                   | GPL-3.0                          |
...
| airgeddon_deb_packages             | Prebuilt .deb mirror (hcxtools, asleap, bettercap, bully)      | https://github.com/v1s1t0r1sh3r3/airgeddon_deb_packages               | Various (repackaged)             |
| dragondrain-and-time               | WPA3 SAE flooding / timing attack tool                         | https://github.com/vanhoefm/dragondrain-and-time                     | GPL-2.0                          |
| ath_masker                         | Atheros radio masking kernel module                            | https://github.com/vanhoefm/ath_masker                               | Unknown                          |
| mdk3                               | Wi-Fi stress testing tool (apt)                                | https://github.com/aircrack-ng/mdk3                                   | GPL-2.0                          |
...
| smbmap                             | SMB share enumeration (Clients image)                          | https://github.com/ShawnDEvans/smbmap                                 | GPL-3.0                          |
...
| naive-hashcat                      | Source of the rockyou.txt wordlist download                    | https://github.com/brannondorsey/naive-hashcat                       | MIT                              |
...
| rtl8812au (aircrack-ng)            | Alfa RTL8812AU/8821AU driver source fallback                   | https://github.com/aircrack-ng/rtl8812au                             | GPL-2.0                          |
| 8821cu (morrownr)                  | Alfa RTL8811CU/8821CU driver source fallback                   | https://github.com/morrownr/8821cu-20210916                          | GPL-2.0                          |
